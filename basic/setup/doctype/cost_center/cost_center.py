...
# from basic.accounts.utils import validate_field_number
...
# 	def autoname(self):
# 		from basic.accounts.utils import get_autoname_with_number
...
# 		from basic.setup.doctype.company.company import get_name_with_abbr
