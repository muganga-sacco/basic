  ...
  filters: [
    {
      fieldname: 'company',
      fieldtype: 'Select',
      options: basic.utils.get_tree_options('company'),
      label: __('Company'),
      default: basic.utils.get_tree_default('company'),
    },
  ],
  root_label: 'Cost Centers',
  get_tree_nodes: 'basic.accounts.utils.get_children',
  add_tree_node: 'basic.accounts.utils.add_cc',
  menu_items: [
    {
