...
def setup_notifications():
    base_path = frappe.get_app_path("basic", "hr", "doctype")
...
def get_post_install_patches():
    return (
        "basic.patches.v10_0.rename_offer_letter_to_job_offer",
        "basic.patches.v10_0.migrate_daily_work_summary_settings_to_daily_work_summary_group",
        "basic.patches.v11_0.move_leave_approvers_from_employee",
        "basic.patches.v11_0.rename_field_max_days_allowed",
        "basic.patches.v11_0.add_expense_claim_default_account",
        "basic.patches.v11_0.rename_additional_salary_component_additional_salary",
        "basic.patches.v11_1.set_salary_details_submittable",
        "basic.patches.v11_1.rename_depends_on_lwp",
        "basic.patches.v12_0.generate_leave_ledger_entries",
        "basic.patches.v12_0.remove_denied_leaves_from_leave_ledger",
        "basic.patches.v12_0.set_employee_preferred_emails",
        "basic.patches.v12_0.set_job_offer_applicant_email",
        "basic.patches.v13_0.move_tax_slabs_from_payroll_period_to_income_tax_slab",
        "basic.patches.v12_0.remove_duplicate_leave_ledger_entries",
        "basic.patches.v12_0.move_due_advance_amount_to_pending_amount",
        "basic.patches.v13_0.move_doctype_reports_and_notification_from_hr_to_payroll",
        "basic.patches.v13_0.move_payroll_setting_separately_from_hr_settings",
        "basic.patches.v13_0.update_start_end_date_for_old_shift_assignment",
        "basic.patches.v13_0.updates_for_multi_currency_payroll",
        "basic.patches.v13_0.update_reason_for_resignation_in_employee",
        "basic.patches.v13_0.set_company_in_leave_ledger_entry",
        "basic.patches.v13_0.rename_stop_to_send_birthday_reminders",
        "basic.patches.v13_0.set_training_event_attendance",
        "basic.patches.v14_0.set_payroll_cost_centers",
        "basic.patches.v13_0.update_employee_advance_status",
        "basic.patches.v13_0.update_expense_claim_status_for_paid_advances",
        "basic.patches.v14_0.delete_employee_transfer_property_doctype",
        "basic.patches.v13_0.set_payroll_entry_status",
        # basic
...
def run_post_install_patches():
    ...
    try:
        for patch in POST_INSTALL_PATCHES:
            ...
            frappe.get_attr(f"basic.patches.post_install.{patch_name}.execute")()
    finally:
